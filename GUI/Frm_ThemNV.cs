...
namespace QL_CaPhe.GUI
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-A8GF1M2\SQLEXPRESS;Initial Catalog=QL_CaPhe;Integrated Security=True");
        public Frm_ThemNV()
        {
            InitializeComponent();
        }
        ...
        private void grp_InfEmployee_Enter(object sender, EventArgs e)
        {
