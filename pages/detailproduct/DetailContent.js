...
<div class="row">
	<div class="col-md-8">
		...
		<p>
		Các thiết kế thời trang nữ nhìn chung đều phù hợp với các hoạt động, sự kiện khác nhau trong cuộc sống hằng ngày như phong cách công sở, đi dạo, đi chơi, đi đu lịch, đi sự kiện, dạ hội, các hoạt động thể thao, vận động mạnh,... vừa thanh lịch, tinh tế và cá tính, sắc nét từ chất liệu, kiểu dáng đến đường kim mũi chỉ.  
		</p>
		<ul class="list-check">
    ...
    <article class="media mb-3">
      <a href="#">  <img src={require("../../assets/images/posts/3.jpg")} className="img-sm mr-3" alt="Image description" /></a>
    ...
    <article class="media mb-3">
      <a href="#"><img src={require("../../assets/images/posts/2.jpg")} className="img-sm mr-3" alt="Image description" /></a>
      <div class="media-body">
    ...
    <article class="media mb-3">
      <a href="#"><img src={require("../../assets/images/posts/1.jpg")} className="img-sm mr-3" alt="Image description" /></a>
      <div class="media-body">
        <h6 class="mt-0"><a href="#">New tips and tricks</a></h6>
        <p class="mb-2"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin </p>
      </div>
